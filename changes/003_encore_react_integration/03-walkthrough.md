...
- When hostname is "origin", fall back to localhost:4002 or ENCORE_API_BASE_URL
...
- Update allowedActionOrigins to host format (localhost:4002) instead of full URLs
